    ...
    return (
        <section className='PlanEstrategico'>
            <div className='descripcion__plan__estrategico'>
                <h1 className='titulo-pe'>Plan estratégico</h1>
            </div>
            ...
            <div className='container__vision'>
                ...
                <div className='vision'>
                    <p className='vision__texto'>Ser el líder en el mercado regional ofreciendo una solución innovadora y confiable para el cuidado de niños en el hogar.</p>
                <img src={sonrisa} className='vision__icono' alt="vision"></img>
                </div>
            </div>
            <div className='container__mision'>
                ...
                <div className='mision'>
                    ...
                    <img src={imgmision} className='img_mision' alt='mision'></img>
                </div>
            </div>
            <div className='container-objetivose'>
                <h1 className='titulo-mision'>Objetivos Estratégicos</h1>
            ...
            <div className='container-obj-med'>
                <h1 className='titulo-mision'>Objetivos Operativos de mediano plazo</h1>
                <div className='container__objE'>
                ...
                <h1 className='titulo-mision'>Objetivos Operativos de largo plazo</h1>
                <div className='container__objE' >
                    <div className='cajas_obj2'>
                        <h1 className='cajas__numeros'>1.</h1>
            ...
            <div className='container_valores'>
                <h1 className='titulo-mision'>Valores empresariales</h1>
            ...
            <div className='container_motivacion'>
                <div>
                    <h1 className='titulo-mision'>¿Cómo motivar al cliente de la empresa?</h1>
            ...
            <div className='container_conclusion'>
                    ...
                    <div className='resumen_texto'>
                        <p className='texto_target'>"La Tata" surge como respuesta a la falta de cuidadores de niños en situaciones de emergencia, detectada a través de una encuesta en línea que reveló la disposición del público objetivo a pagar por un servicio de calidad. <br/><br/>Nuestra empresa se propone ser líder en el mercado regional a través de una aplicación que ofrece un acceso innovador y práctico al cuidado de niños. <br/><br/>La estrategia de diferenciación se basa en la calidad del servicio, la tecnología innovadora y la capacitación rigurosa de las babysitters. Además, se compromete a fomentar la transparencia, la comunicación clara y una experiencia positiva para el cliente mediante la personalización del servicio y la participación activa en la comunidad.</p>
                        <img src={celus} alt="imagen ilustrativa de la aplicación" style={{ width: '40%' }}></img>
                    </div>
                </div>
        </section >
    )
