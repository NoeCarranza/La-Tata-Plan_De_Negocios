  ...
  return (
    <section>
            ...
            <div className='organigrama'>
              ...
              <img className='img-organigrama' src={organigrama} alt='organigrama de la empres'></img>
            </div>
            <div className='container-cde'>
            <h1 className='titulo-mision'>Codigos de ética</h1>
                <div className='cde-trab'>
                  <img src={cdetrab} alt='codigo de etica del trabajador' className='img-cde'></img>
                  <img src={cdeemp} alt='codigo de etica del empleador' className='img-cde2'></img>
                </div>
            </div>
            ...
            <div className='div_incentivos'>
              <img src={incentivos}alt='incentivos' className='img-incentivos'></img>
            </div>
            </div>
            <div className='container-hys'>
            <h1 className='titulo-mision'>Higiene y seguridad</h1>
            <div className='hys-tipos'>
              <img src={hysbby} alt='higiene y seguridad de las babysitters' className='img-hysb'></img>
              <img src={hysbby2} alt='higiene y seguridad de las babysitters' className='img-hysb2'></img>
            </div>
              <img src={hysoff} alt='higiene y seguridad en la oficina' className='img-hyso'></img>
            </div>
            <div className='container-capacitaciones'>
            <h1 className='titulo-mision'>Desarrollo de carrera</h1>
            <div className='capacitacion-bby'>
                  <img src={capbby} alt='capacitaciones babysitter'></img>
                  <img src={capbby2} alt='capacitaciones babysitter'></img>
                  <img serc={capbby3} alt='capacitaciones babysitter'></img>
            </div>
            </div>
    </section>
  )
