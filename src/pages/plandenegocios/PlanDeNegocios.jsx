    ...
    return (
        <section className="container_plandenegocios">
            ...
            <div className="descripcion_final">
                ...
                <p style={{width:'40%', fontSize:'30px'}}>
